...
--Quando se cria um novo aluno do 11º ano do curso de Ciências e Tecnologias, este terá que fazer obrigatoriamente o exame
--de Economia A do ano letivo mais recente, da 1ª fase

CREATE TRIGGER IF NOT EXISTS InsertNovoAlunoExameEconomia
AFTER INSERT ON Aluno
FOR EACH ROW 
WHEN NEW.anoEscolaridade = 11 AND NEW.codCurso = 'C61'
BEGIN 
    INSERT INTO AlunoRealiza VALUES(NEW.idAluno,56,NULL,'S',NULL,'N','N','N','N');
END;
