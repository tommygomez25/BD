...
BEGIN
INSERT INTO AlunoRealiza VALUES(NEW.idAluno,(SELECT idExame FROM Exame E1 WHERE E1.fase = 2 AND ((E1.anoLetivo, E1.codExame) IN (SELECT anoLetivo, codExame FROM Exame E2 WHERE NEW.idExame = E2.idExame))) , NEW.sitFrequencia, NEW.serInterno, NULL, NEW.paraAprov, NEW.paraMelhoria, NEW.ProvaIngresso, NEW.CFCEPE); 
END;
